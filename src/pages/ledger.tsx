...
function Ledger() {
    ...
    <div className='size-full flex flex-col justify-center items-center'>
                ...
                <table className='w-full border-collapse border border-gray-300 table-fixed'>
                    ...
                    <tbody className=''>
                        ...
                        <tr className='h-[60px] max-h-[60px] text-center' key={entry.id}>
                            <td className=''><input type="date" onChange={(e) => handleEditEntry(entry.id,'date',e)} value={entry.date} className='bg-white border rounded-md overflow-hidden px-1 w-9/10'></input></td>
        ...
        <div className={`transition-opacity size-fit flex items-center justify-center text-black mt-4 ${entries.length > 0 ? 'opacity-100' : 'opacity-0'}`}>
